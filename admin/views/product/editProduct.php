        ...
        <div class="table-commodities">
            <form action="index.php?act=updateProduct" method="post" enctype="multipart/form-data">
                <table class="commodities">
                    ...
                    <tr>
                        <td>Tên sản phẩm</td>
                        <td><input value="<?php echo $listsp['name_product'] ?>" name="name-product" type="text"></td>
                    </tr>
                    <tr>
                        <td>Ảnh</td>
                        <td>
                    ...
                    <tr>
                        <td>Camera sau</td>
                        <td><input value="<?php echo $listsp['camera_selfie'] ?>" name="camera_selfie" type="text"></td>
                    </tr>
                    <tr>
                        <td>Xuất sứ</td>
